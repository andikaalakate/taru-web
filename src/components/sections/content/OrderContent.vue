<template>
    <section class="text-[#00000f] bg-[#fffff0] min-h-screen px-[5%] md:px-[10%] xl:px-[20%] pb-4 pt-22">
        <h1 class="text-4xl font-bold text-center">Paket Pesanan</h1>
        <p class="text-xl text-[#13495a] text-center">Menawarkan produk terbaik dengan harga yang terjangkau</p>
        <div class="justify-center items-center flex flex-wrap py-20 gap-6">
            <div class="w-72 bg-[#fffff0] border border-[#00000f30] p-4 rounded-lg shadow-xl">
                <div class="flex items-center justify-center py-6">
                    <box-icon name='book-open' color="#13495a" class="size-12"></box-icon>
                </div>
                <h2 class="text-2xl font-semibold text-center">Starter Spark</h2>
                <div id="harga" class="flex justify-center">
                    <span class="flex items-start text-md">Rp.</span>
            ...
            <div class="w-72 bg-[#fffff0] border border-[#00000f30] p-4 rounded-lg shadow-xl">
                ...
                <h2 class="text-2xl font-semibold text-center">Momentum Engine</h2>
                <div id="harga" class="flex justify-center">
                    <span class="flex items-start text-md">Rp.</span>
                    <p class="text-6xl ">1,5</p>
                    <span class="flex items-center text-md">Jt</span>
                </div>
                <ul>
                    <li class="flex items-center gap-2">
            ...
            <div class="w-72 bg-[#fffff0] border border-[#00000f30] p-4 rounded-lg shadow-xl">
                ...
                <h2 class="text-2xl font-semibold text-center">Prime Velocity</h2>
                <div id="harga" class="flex justify-center">
                    <span class="flex items-start text-md">Rp.</span>
