...
<template>
  ...
  <main class="pt-30 px-5 sm:px-10 xl:px-20 py-10 max-w-screen-lg mx-auto">
    <section v-if="post">
      ...
      <div class="relative overflow-hidden max-h-80 aspect-video justify-center mx-auto"><img :src="post.image" :alt="post.title" class="h-full w-full rounded-lg mb-8 object-cover" /></div>
